# 👋 Hello there — I'm Durgapada Karan !
**AI & ML Enthusiast | Backend Developer in Progress(web dev currently) | Problem Solver | Lifelong Learner**

Welcome to my corner of the digital world. 🌍  

Hi, I'm **Durgapada** — a B.Tech student specializing in **Computer Science (AI & ML)** at *The Neotia University*.  
...
**Frameworks & Tools:**  
`Flutter` • `Android Studio` • `Git` 

**AI/ML Tools:**  
`NumPy` • `Pandas` • `TensorFlow (Learning)`  

**Databases:**  
`MySQL` • `PostgreSQL`  

**Development:**  
`Backend Logic` • `Flask (Learning)`  

**Other Tools:**  
`VS Code` • `PowerShell` • `GitHub`  

**Learning Platforms:**  
`Physics Wallah (GATE CSE Prep 2026)` • `LeetCode`  • `YouTube` • `Udemy`    

---

## 🎓 Education
🎓 **B.Tech in Computer Science & Engineering (AI & ML)**  
*The Neotia University* — CGPA: **7.5**

🏫 **Higher Secondary (Science)** — *Gurgram Shikhanikatan High School (H.S.)* — **86%**  
🏫 **Secondary Education (10th)** — *Gurgram Shikhanikatan High School (H.S.)* — **75%**  
